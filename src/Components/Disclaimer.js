      ...
      <section className="p-1">
				...
				<div>
					<div className="container p-2">
						...
						<p>
							<b>Contributing to RESOC</b>: Contributing to RESOC is an excellent way to give back to the community and share your knowledge with the world. We are always looking for contributors. If you are interested in contributing to RESOC, please contact us via the <Link className='text-var' to='/contributions'>contributions page</Link>.  Make sure that the uploaded documents are in <b>pdf, or a zip file of pdfs only</b>. We do not accept any other file formats. You must be logged in while submitting a request since we require your associated email and name for further communication. You always have the option of logging in through any email address you want, but make sure that you are available to communicate using that email address. If you are unable to upload your notes, please contact us via the community chat or email. We'll be happy to help you out. We'll be glad to accept your contributions after scrutiny to ensure that the content is of high quality and is not misleading. As a contributor, you'll be listed in the contributors' list, and you can always add your donations/sponsorship links there. In any case, RESOC will always be happy to help you out, even if you're not able to add your details.
						</p>
						<p>
