				...
				<div>
					<div className="container p-5">
						<p>
							...
							<p>
							This entire site has been built by like minded students of Silicon Institute for free ❤️. If you like our work, please consider donating to us. This really helps us to keep the site running and to keep adding new features.
							<div className='sponsor py-3'>
								<a href='https://www.buymeacoffee.com/resoc' target='_blank' rel='noreferrer'>
